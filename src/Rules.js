    ...
    return (
      <div className="rules-div">
        ...
        Crypto Against Humanity is a platform for content creation of card combinations.<br/><br/>
         ...
         Users can create white cards which can then be bought and sold for ether on the Play page.
         ...
         it's worth quite a bit more to sell than Alice bought it for, Alice sells her cards back to the market for Eth and gets ready to play again!</div>
      </div>
    );
  }
}
